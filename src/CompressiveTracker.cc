...
CompressiveTracker::CompressiveTracker(void)
{
	...
	rSearchWindow = 45; // size of search window
...
void CompressiveTracker::init(Mat& _frame, Rect& _objectBox)
{
	...
	classifierUpdate(samplePositiveFeatureValue, muPositive, sigmaPositive, 0);
	classifierUpdate(sampleNegativeFeatureValue, muNegative, sigmaNegative, 0);
}
